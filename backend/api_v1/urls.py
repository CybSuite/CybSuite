...
urlpatterns = [
    ...
    path('nav_links/', views.get_navbar, name='nav_links'),  # Frontend expects this endpoint
    ...
    path('schema/entity/<str:entity>/names/', views.get_entity_field_names, name='entity_field_names'),
    path('schema/field/<str:entity>/<str:field>/', views.get_field_schema, name='field_schema'),
    ...
    path('data/record/<str:entity>/<int:record_id>/', views.get_record_detail, name='record_detail'),
    ...
    path('data/<str:entity>/<int:record_id>/', views.delete_record, name='delete_record'),
