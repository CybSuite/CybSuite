...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-z@g2n9zf-e!22iha%g5@95qdt(t6m1npe*0w8)r_+8=375#$hs')
...
CORS_ALLOWED_ORIGINS_ENV = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://127.0.0.1:3000,http://backend:8000,http://0.0.0.0:13370')
...
# API Configuration
ENABLE_TEST_ENDPOINTS = DEV or os.getenv('ENABLE_TEST_ENDPOINTS', 'false').lower() == 'true'
